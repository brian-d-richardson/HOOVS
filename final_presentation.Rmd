...
I. Use LASSO penalized ordinal regression and ordinal random forest models to reduce data set dimensionality.

II. Compare results (selected features and model performance) between the LASSO penalized ordinal regression and ordinal random forest models

III. Conduct inference on selected features using an unpenalized ordinal regression model to identify the magnitude and direction of covariate effects on life satisfaction.
