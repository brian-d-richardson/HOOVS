...
To achieve the goal of identifying factors associated with life satisfaction, we aim to reduce the dimentionlaity, with two methods: ordinal LASSO regression and Random Forests. 
